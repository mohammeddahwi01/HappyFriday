...
class Socialshare extends \Magento\Framework\View\Element\Template
{
    ...
    public function getFacebookButton()
    {
		...
		$_u = 'p[url]=' . $this->_product->getProductUrl() . '&p[images][0]=' . $this->_product->getImage() . '&p[title]=' . $this->_product->getName() . '&p[summary]=' . urlencode(trim($this->_product->getShortDescription())); 
		
		return '<div class="facebook_button social-button">
		<a href="http://www.facebook.com/sharer.php?s=100&' . $_u.'" target="_blank" title="'.__('Share on Facebook').'"><i class="fa fa-facebook"></i></a>
		</div>';
...
<script>(function(d, s, id) {
  ...
  <div class="fb-like" data-layout="' . $count_button . '" data-width="400" data-show-faces="false"  data-href="' . $this->_product->getProductUrl() . '"  data-send="' . $like_button . '"></div></div>';*/
    ...
    public function getTwitterButton()
    {
		...
		<a href="http://twitter.com/home?status=' . $this->_product->getName() . '+' . $this->_product->getProductUrl().'" target="_blank" title="'.__('Share on Twitter').'"><i class="fa fa-twitter"></i></a>
		</div>';
  ...
  <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script></div>";*/
    ...
    public function getPinItButton()
    {
		...
		$imageUrl=$conf.'pub/media/catalog/product'.$this->_product->getImage();
		
		return '<div class="pinit_button social-button">
		<a href="https://pinterest.com/pin/create/button/?url='.urlencode($this->_product->getProductUrl()).'&media='.urlencode($imageUrl).'&description='.urlencode($this->_product->getName()).'" target="_blank" title="'.__('Pin it').'"><i class="fa fa-pinterest-p"></i></a>
		</div>';
