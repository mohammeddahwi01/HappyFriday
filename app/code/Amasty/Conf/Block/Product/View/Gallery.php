...
class Gallery extends \Magento\Catalog\Block\Product\View\Gallery
{
    ...
    public function __construct(
        ...
        $this->helper = $helper;
        $this->viewConfig = $context->getViewConfig();
    }
    ...
    {
        $config = [
            'small_size' => $this->viewConfig->getViewConfig()->getMediaAttributes(
                'Magento_Catalog',
                'images',
                'product_page_image_small'
            ),
            'medium_size' => $this->viewConfig->getViewConfig()->getMediaAttributes(
                'Magento_Catalog',
                'images',
    ...
    private function generateCarouselConfig(&$result)
    {
        $config = [
            ...
            'main_image_swipe' => (bool)$this->helper->getModuleConfig('carousel/main_image_swipe')
        ];
